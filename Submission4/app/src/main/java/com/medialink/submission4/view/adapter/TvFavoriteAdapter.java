...
public class TvFavoriteAdapter extends RecyclerView.Adapter<TvFavoriteAdapter.MyViewHolder> {

    private static final String TAG = "TvFavoriteAdapter";
    private ArrayList<FavoriteItem> listFavorite = new ArrayList<>();
    private Context mContext;
    private FavoriteTvContract.ViewInterface mViewFragInface;

    public TvFavoriteAdapter(Context mContext, FavoriteTvContract.ViewInterface mViewInterface) {
        this.mContext = mContext;
        this.mViewFragInface = mViewInterface;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        String releaseLabel = mContext.getString(R.string.label_first_air);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mViewFragInface.itemFavoriteClick(item, position);
            }
        });
        holder.btnFavDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mViewFragInface.itemDelete(String.valueOf(item.getId()), position);
            }
        });
    }
