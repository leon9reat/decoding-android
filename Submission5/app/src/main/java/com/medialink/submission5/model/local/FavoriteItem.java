...
@Entity(tableName = Const.TABLE_FAVORITE)
public class FavoriteItem implements Parcelable {
    @PrimaryKey(autoGenerate = true)
    @ColumnInfo(index = true, name = Const.FIELD_FAVORITE_ID)
    public Long id;

    @ColumnInfo(name = Const.FIELD_FAVORITE_MOVIE_ID)
    public int movieId;

    @ColumnInfo(name = Const.FIELD_FAVORITE_TYPE_ID)
    public int typeId; // 1 movie; 2 tv

    @ColumnInfo(name = Const.FIELD_FAVORITE_POSTER_PATH)
    public String posterPath;

    @ColumnInfo(name = Const.FIELD_FAVORITE_TITLE)
    public String title;

    @ColumnInfo(name = Const.FIELD_FAVORITE_RELEASE_DATE)
    public String releaseDate;

    @ColumnInfo(name = Const.FIELD_FAVORITE_OVERVIEW)
