...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.medialink.mystackwidget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.medialink.mystackwidget.EXTRA_ITEM";
